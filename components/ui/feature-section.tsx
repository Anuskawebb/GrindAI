    ...
    <div className={cn("p-8 md:p-12 bg-white", className)}>
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-10">
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className={cn(
                    "text-sm md:text-lg",
                    index === currentFeature ? "text-gray-700" : "text-gray-500"
                  )}>
                    {feature.content}
                  </p>
                </div>
          ...
          <div
            className={cn(
              "order-1 md:order-2 relative h-[200px] md:h-[300px] lg:h-[400px] overflow-hidden rounded-lg border border-gray-200 shadow-lg"
            )}
          >
