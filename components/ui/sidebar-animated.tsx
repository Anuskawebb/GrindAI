...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      ...
      style={{ overflow: 'visible', overflowX: 'visible', overflowY: 'auto' }}
      animate={{
...
export const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 px-3 rounded-lg hover:bg-gray-100 transition-colors relative",
    ...
    >
      <span className={cn(
        "flex-shrink-0 relative z-10 min-w-[20px] flex items-center justify-center",
      ...
      <motion.span
        ...
        className={cn(
          "text-sm group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0 relative z-10",
